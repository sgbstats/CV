...
vitae::bibliography_entries("bib.bib") %>% 
  filter(id %in% c("bate2024external", "batek360", "akris", "gbm", "FI", "pla2r", "CSOM", "flame", "oremule2023mobile", "cpap", "etp", "bate_predictors_2025")) %>%
  arrange(desc(issued))
```
...
-   This CV was written in Quarto using *{vitae}*