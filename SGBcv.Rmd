...
```{r}
tribble(~note,
  list("I have run a 3:28:52 marathon",
       "This CV was written in RMarkdown using {vitae}")) %>% 
  detailed_entries(why=note)
```